#ifndef PANGO_SPI_FLASH_H
#define PANGO_SPI_FLASH_H
...
#define SFLASH_FAST_READ_DUAL     0x3B                     //快读数据（双线数据输出）
...
void SFLASH_FastReadNByte(uint8_t* pBuffer, uint32_t ReadAddr, uint16_t nByte);     //块读n字节数据
