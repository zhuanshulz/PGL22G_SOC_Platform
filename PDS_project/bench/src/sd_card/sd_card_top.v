...
assign SD_RESP = 1'b0;
assign SD_READYOUT = 1'b1;
assign SPI_LOW_SPEED_DIV = 16'd498;
assign SPI_HIGH_SPEED_DIV = 16'd2;

assign sd_sec_write_data = TRANSDATA[wr_data_cnt];

wire[4:0] state1;
assign state1 = 5'b10001;
always @(posedge HCLK or negedge rst) begin
	if(~rst)
		STATUS <= 32'd0;
	else
	 	STATUS <= 32'h14141414;				// 5 bits
end
